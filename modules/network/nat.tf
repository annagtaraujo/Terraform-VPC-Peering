...
resource "aws_nat_gateway" "nat_a"{
    ...
    subnet_id     = aws_subnet.vpc-public-subnet-a[0].id #aws_subnet.vpc-public-subnet-a-nat-anchor.id
    tags = {
...
resource "aws_nat_gateway" "nat_b"{
    ...
    subnet_id     = aws_subnet.vpc-public-subnet-b[0].id #aws_subnet.vpc-public-subnet-b-nat-anchor.id
    tags = {
...
resource "aws_nat_gateway" "nat_c"{
    ...
    subnet_id     = aws_subnet.vpc-public-subnet-c[0].id #aws_subnet.vpc-public-subnet-c-nat-anchor.id
    tags = {
